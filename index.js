...
// number1 =400;
// console.log(number1);400
// number1 ='pple';
// console.log(number1);pple

// const name = { firstName :'peter'};
// name.firstName= 'tony';
// console.log(name);//firstname :tony
// console.log(name.firstName);//tony

// Block scope
// let and const block scope (Functional scope) {}
// var global scope
...
// console.log(number1);
// var number1=200;undefined

// console.log(num2);
// const num2 =300;
// sample.js:33 Uncaught ReferenceError: Cannot access 'num2' before initialization
...
//     console.log(random);
// }
// // console.log(random); //outer scope
...
//   console.log(value);//some random values
// }

// console.log(total);//1000
// console.log(test);//true
// // console.log(value); //error becuase out of scope
...
//     2} years old fullname ${name+lastName}`;

// console.log(phrase);
// // My full name is krish patel and I'm 24years old.
// console.log(phrase2);
// // My full name is krish PATEL and I'm 48 years old fullname krishpatel

////////////////////////////////////////////////////
// Template Strings html (backtics)

// const person = {
//     name:"alex",
//     job: "dev",
//     hobbies:["surf","bake","purple"],
// };

// console.log(person);
// {name: 'alex', job: 'dev', hobbies: Array(3)}
// hobbies:(3) ['surf', 'bake', 'purple']
// job: "dev"
// name :  "alex"
...
// console.log(quote);
// // Here is the Some Statement by Some Author and it could not be more true
// console.log(author);
...
//   console.log(result);
// console.log(highlight()); something wrong with the code

/////////////////////////
// Arrow function or fat arrow
// no name, no function keyword, paramters and return statement, no params

function sayHi () {
    console.log("hello variable inside SayHi");
    }
